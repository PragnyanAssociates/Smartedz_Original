...
export default function WelcomePage() {
  ...
  return (
    <div className="welcome-bg relative flex min-h-screen flex-col items-center justify-center overflow-x-hidden bg-zinc-50 bg-cover bg-center bg-no-repeat px-6 py-10 sm:px-12">

...
import { 
  ...
  Video, FileSpreadsheet, Link as LinkIcon, Search
} from 'lucide-react';
              ...
              return (
                <div key={item.id} className="group bg-white rounded-2xl shadow-sm border border-slate-200 flex flex-col hover:shadow-md transition-all">
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    {item.subject_name && <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">{item.subject_name}</p>}
